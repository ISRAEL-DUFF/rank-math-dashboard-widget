...
function load_scripts() {
	if(is_admin()) {
		wp_enqueue_script( 'wp-rank-math-analysis', WPRK_URL . 'build/index.js', [ 'wp-element', 'wp-api-fetch' ], wp_rand(), true );
		wp_localize_script( 'wp-rank-math-analysis', 'appLocalizer', [
